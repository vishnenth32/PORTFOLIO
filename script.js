...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.skill-category, .project-card, .timeline-item, .stat, .contact-item, .resume-card');
...
document.querySelector('.resume-card .btn').addEventListener('click', function(e) {
    e.preventDefault();
